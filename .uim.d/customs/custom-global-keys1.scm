...
(define generic-next-page-key '("next" "tab"))
(define generic-next-page-key? (make-key-predicate '("next" "tab")))
(define generic-prev-page-key '("prior" "<Shift>tab"))
(define generic-prev-page-key? (make-key-predicate '("prior" "<Shift>tab")))
